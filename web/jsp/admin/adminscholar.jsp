...
<s:iterator value="#session.scholars" status="maprowStatus">
  <tr align="center">
    <s:if test="#maprowStatus.odd == true">
      ...
      <td style="display : none" id="id"><s:property value="scholarID"/></td>
...
<table>
<tr align="center"><td ><input value="VIEW" type="button" onclick="dphandler('scholar')"/></td><td ><input value="NEW" type="button"  onclick="clickhandler('scholar')"/></td><td ><input value="DELETE" type="button" onclick="clickhandler('deletescholar')"/></td></tr>
</table>
